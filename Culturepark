##CulturePark## is an innovative framework designed to enhance cross-cultural understanding in large language models (LLMs). It employs a multi-agent communication system where LLM-based agents simulate human interactions across diverse cultural backgrounds. This approach generates high-quality dialogues that encapsulate human beliefs, norms, and customs, addressing cultural biases inherent in many LLMs.
...
1.  ##"CulturePark: Boosting Cross-cultural Understanding in Large Language Models"## by Cheng Li et al. (2024). This paper introduces CulturePark and discusses its methodology and applications.
    
    [arXiv](https://arxiv.org/abs/2405.15145)
    
2.  ##"CulturePark: Boosting Cross-cultural Understanding in Large Language Models"## by Cheng Li et al. (2024). This version provides a detailed HTML format of the study.
    
    [arXiv](https://arxiv.org/html/2405.15145v2)
    
3.  ##"CulturePark: Boosting Cross-cultural Understanding in Large Language Models"## by Cheng Li et al. (2024). This PDF version offers a comprehensive overview of the framework.
